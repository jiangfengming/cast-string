...
function createCastObject(source) {
  function getValue(key, isArray) {
    if (isArray === void 0) {
      isArray = false;
    }
  ...
  return {
    ...
    arrayOfInt: function arrayOfInt(key, _temp15) {
      ...
      return _arrayOfInt(getValue(key, true), {
        radix: radix,
        defaults: defaults,
        dedup: dedup,
    ...
    arrayOfFloat: function arrayOfFloat(key, _temp16) {
      ...
      return _arrayOfFloat(getValue(key, true), {
        defaults: defaults,
        dedup: dedup,
        splitComma: splitComma,
        "throws": _throws13
    ...
    arrayOfNumber: function arrayOfNumber(key, _temp17) {
      ...
      return _arrayOfNumber(getValue(key, true), {
        defaults: defaults,
        dedup: dedup,
        splitComma: splitComma,
        "throws": _throws14
    ...
    arrayOfString: function arrayOfString(key, _temp18) {
      ...
      return _arrayOfString(getValue(key, true), {
        defaults: defaults,
        dedup: dedup,
        splitComma: splitComma,
        "throws": _throws15
...
export { _arrayOfFloat as arrayOfFloat, _arrayOfInt as arrayOfInt, _arrayOfNumber as arrayOfNumber, _arrayOfString as arrayOfString, _bool as bool, createCastObject, _float as float, _int as int, _number as number, _string as string };
